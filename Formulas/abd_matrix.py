...
def tEpsilonMatrix(theta):
    ...
    sinus_theta = math.sin(math.radians(theta))
    cosinus_theta = math.cos(math.radians(theta))
    #Determine entries of the T-epsilon-matrix
    t11 = cosinus_theta**2
    t12 = sinus_theta**2
    t13 = sinus_theta*cosinus_theta
    t31 = -2*sinus_theta*cosinus_theta
    t33 = cosinus_theta**2 - sinus_theta**2
    #Assemble T-epsilon-matrix
    tEpsilon = np.array([[t11, t12, t13],
                       [t12, t11, -t13],
                       [t31, -t31, t33]])
    return tEpsilon